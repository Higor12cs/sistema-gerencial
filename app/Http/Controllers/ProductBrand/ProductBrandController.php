...
class ProductBrandController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('app.product-brands.index', compact('productBrands'));
    }
    ...
    {
        return view('app.product-brands.create');
    }
    ...
    {
        return view('app.product-brands.show', compact('productBrand'));
    }
    ...
    {
        return view('app.product-brands.edit', compact('productBrand'));
    }
