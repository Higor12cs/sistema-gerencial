...
class ProductCategoryController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('app.product-categories.index', compact('productCategories'));
    }
    ...
    {
        return view('app.product-categories.create');
    }
    ...
    {
        return view('app.product-categories.show', compact('productCategory'));
    }
    ...
    {
        return view('app.product-categories.edit', compact('productCategory'));
    }
