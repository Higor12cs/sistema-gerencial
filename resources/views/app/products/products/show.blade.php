...
@php
    $heads = [['label' => __('Código'), 'width' => 10], __('Tamanho'), __('Valor'), ['label' => __('Ativo'), 'width' => 10], ['label' => __('Ações'), 'no-export' => true, 'width' => 5]];
    ...
    foreach ($productVariants as $productVariant) {
        ...
        $productVariantsData[] = [$productVariant->id, $productVariant->productSize->name ?? '-', number_format($productVariant->price / 100, 2, ',', '.'), $productVariant->active ? '<span class="badge badge-success">Ativo</span>' : '<span class="badge badge-danger">Desativado</span>', '<nobr>' . $btnShow . $btnEdit . '</nobr>'];
    }
