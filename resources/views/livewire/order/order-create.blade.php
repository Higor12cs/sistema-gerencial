<div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <button wire:click="addProduct" class="btn btn-primary btn-xs text-nowrap"
                            wire:loading.attr="disabled">Adicionar Produto</button>
                    </td>
                </tr>
                @foreach ($orderItems as $product)
                    <tr>
                        ...
                        <td>
                            <button wire:click="removeProduct({{ $product['index'] }})" class="btn btn-xs btn-danger"
    ...
    <div class="d-flex justify-content-between mt-2">
        <button wire:click="finishOrder" class="btn btn-primary" @disabled($totalAmount == 0)>Finalizar
            Condicional</button>
